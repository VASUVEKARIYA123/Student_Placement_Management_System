                            ...
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="email" type="text" class="form-control email" id=""
                                        onkeyup="generateCV()" placeholder="e.g. vasuvekariya@gmail.com" required>
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="exp_start_date" type="date"
                                                    class="form-control exp_start_date" id="" onkeyup="generateCV()" required>
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                            ...
                                            <div class="form-elem">
                                                ...
                                                <input name="exp_description" type="text"
                                                    class="form-control exp_description" id="" onkeyup="generateCV()" required>
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="edu_start_date" type="date"
                                                    class="form-control edu_start_date" id="" onkeyup="generateCV()" required>
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">End Date</label>
                                            ...
                                            <div class="form-elem">
                                                ...
                                                <input name="edu_description" type="text"
                                                    class="form-control edu_description" id="" onkeyup="generateCV()" required>
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
